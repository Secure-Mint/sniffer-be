...
//       detail:
//         "Top 10 holders control more than 15% of the total supply, indicating high holder concentration and an increased risk of manipulation.",
...
//     detailedAnalysis.push({
//       detail: "Unable to determine supply distribution among the top 10 holders. No Circulating supply increases uncertainty and risk.",
//       risk: RISK_STATUS.HIGH_RISK
//     });
//   }
...
//     detailedAnalysis.push({
//       detail:
//         "Top 20 holders control more than 40% of the total supply, showing strong centralization of supply and a significant risk of coordinated sell offs.",
//       risk: RISK_STATUS.HIGH_RISK
//     });
...
//     detailedAnalysis.push({
//       detail: "Unable to determine supply distribution among the top 20 holders. No Circulating supply increases uncertainty and risk..",
//       risk: RISK_STATUS.HIGH_RISK
//     });
//   }
...
//   // === 5. Honey Pot ========================================
//   if (isHoneyPot) score -= HONEY_POT_PENALTY;

//   // === 5. Rug Pull ========================================
//   if (isRugPull) score -= RUG_PUL_PENALTY;
